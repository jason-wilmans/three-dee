...
*****     Sources     *****
***************************
@S    FlareArtifactShader => 913d648c19ede00d9b3cfa1db476c598
...
//
#line 95 "C:\Users\jason\Documents\Work\Uni\three-dee\1 - Code\ThreeDeeUi\ThreeDeeUi\Bin\Windows\Debug\log\shader_FlareArtifactEffect_edffe4eb535a714d1e3f81864fe03dc3.hlsl"
...
//
#line 76 "C:\Users\jason\Documents\Work\Uni\three-dee\1 - Code\ThreeDeeUi\ThreeDeeUi\Bin\Windows\Debug\log\shader_FlareArtifactEffect_edffe4eb535a714d1e3f81864fe03dc3.hlsl"
...
float4 Shading_id3(inout PS_STREAMS streams)
{
    ...
    for (int i = 0; i < TapCount_id73; i++)
    {
        ...
        if (distortedUV.x < 0 || distortedUV.x > 1 || distortedUV.y < 0 || distortedUV.y > 1)
            tapColor = float4(0.0, 0.0, 0.0, 1.0);
