...
@C    constantFloat_id100 => Material.GlossinessValue
@C    constantFloat_id103 => Material.MetalnessValue
...
//
#line 637 "C:\Development\three-dee\1 - Code\ThreeDeeCore\CoreFacade\log\shader_XenkoEditorForwardShadingEffect_5f36f01c3f5ae7484e541abe7f3a690b.hlsl"
...
@G    Pixel => a1d333aef6eba36cf42fe22c9e4faba9
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float constantFloat_id100;         // Offset:   16 Size:     4
//   float constantFloat_id103;         // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 666 "C:\Development\three-dee\1 - Code\ThreeDeeCore\CoreFacade\log\shader_XenkoEditorForwardShadingEffect_5f36f01c3f5ae7484e541abe7f3a690b.hlsl"
...
mad r0.xyz, r2.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id176 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id176 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id176 return value>.z
...
const static bool TInvert_id101 = false;
const static bool TIsEnergyConservative_id107 = false;
static const float PI_id109 = 3.14159265358979323846;
...
cbuffer PerMaterial 
{
    ...
    float constantFloat_id100;
    float constantFloat_id103;
};
cbuffer PerView 
{
    float4x4 View_id22;
...
float NormalDistributionGGX_id175(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id109 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id109 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
{
    return float4(constantFloat_id103, constantFloat_id103, constantFloat_id103, constantFloat_id103);
}
float4 Compute_id220()
{
    return float4(constantFloat_id100, constantFloat_id100, constantFloat_id100, constantFloat_id100);
}
float4 Compute_id218()
{
...
void Compute_id391(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id109 + environmentLightingContribution;
...
{
    float4 colorBase = Compute_id218();
