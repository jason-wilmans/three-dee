...
//
#line 239 "C:\Development\three-dee\1 - Code\ThreeDeeCore\CoreFacade\log\shader_XenkoEditorForwardShadingEffect_77f014243c62323b8e7689d72b02d3d6.hlsl"
...
@G    Pixel => fdab340d30341b1cb61fd44c1a9ad50b
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
// {
//
//   float Time_id85;                   // Offset:    0 Size:     4
//
// }
//
// cbuffer PerMaterial
...
//
#line 243 "C:\Development\three-dee\1 - Code\ThreeDeeCore\CoreFacade\log\shader_XenkoEditorForwardShadingEffect_77f014243c62323b8e7689d72b02d3d6.hlsl"
mul r0.x, cb0[0].x, l(6.000000)
sincos r0.x, null, r0.x
mad r0.x, r0.x, l(0.250000), l(0.250000)  // r0.x <- factor

#line 109
mul r1.xyz, cb1[0].xyzx, cb2[22].xyzx  // r1.x <- <ComputeEnvironmentLightContribution_id88 return value>.x; r1.y <- <ComputeEnvironmentLightContribution_id88 return value>.y; r1.z <- <ComputeEnvironmentLightContribution_id88 return value>.z
...
float GetFilterSquareRoughnessAdjustment_id62(inout PS_STREAMS streams, float3 averageNormal)
{
...
void ResetStream_id73()
{
}
float3 ComputeEnvironmentLightContribution_id88(inout PS_STREAMS streams)
{
...
void PrepareMaterialForLightingAndShading_id72(inout PS_STREAMS streams)
{
    ...
    float roughnessAdjust = GetFilterSquareRoughnessAdjustment_id62(streams, streams.matNormal_id45);
    streams.alphaRoughness_id63 = max(roughness * roughness + roughnessAdjust, 0.001);
}
void ResetLightStream_id71(inout PS_STREAMS streams)
{
...
void Compute_id125(inout PS_STREAMS streams)
{
    UpdateNormalFromTangentSpace_id19(streams.matNormal_id45);
    ResetLightStream_id71(streams);
    PrepareMaterialForLightingAndShading_id72(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id88(streams);
        }
    }
...
{
    float factor = sin(Time_id85 * 6.0f) * 0.25f + 0.25f;
