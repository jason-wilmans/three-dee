...
//
#line 132 "C:\Development\three-dee\1 - Code\ThreeDeeCore\CoreFacade\log\shader_ColorTransformGroupEffect_bc724998c8da3e918b77053e0acb449a.hlsl"
...
@G    Pixel => e341f1a19dc351d87a66760698c1b9f5
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 107 "C:\Development\three-dee\1 - Code\ThreeDeeCore\CoreFacade\log\shader_ColorTransformGroupEffect_bc724998c8da3e918b77053e0acb449a.hlsl"
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, v1.xyxx, t0.xyzw, s0  // r0.x <- <Shading_id2 return value>.x; r0.y <- <Shading_id2 return value>.y; r0.z <- <Shading_id2 return value>.z; r0.w <- <Shading_id2 return value>.w

#line 92
lt r1.x, l(0.000000), cb0[5].z
if_nz r1.x
  sample_indexable(texture2d)(float,float,float,float) r1.x, v1.xyxx, t1.xyzw, s1  // r1.x <- luminanceAverageLocal
  add r1.x, r1.x, -cb0[5].w
  mad r1.x, cb0[5].z, r1.x, cb0[5].w  // r1.x <- avgLuminance
else 
  mov r1.x, cb0[5].w  // r1.x <- avgLuminance
endif 
exp r1.x, r1.x
max r1.x, r1.x, l(0.000100)
exp r1.y, cb0[5].w  // r1.y <- globalAverageLum
mad r0.xyz, r1.yyyy, cb0[6].yyyy, r0.xyzx
...
mad r0.xyz, r1.zzzz, r0.xyzx, r1.yyyy
max r0.xyz, r0.xyzx, l(0.000100, 0.000100, 0.000100, 0.000000)  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z

#line 74
add r1.y, r1.x, l(1.000000)
log r1.y, r1.y
mad r1.y, r1.y, l(0.301030), l(2.000000)
div r1.y, l(2.000000), r1.y
add r1.y, -r1.y, l(1.030000)  // r1.y <- keyValue
div r1.x, r1.y, r1.x  // r1.x <- linearExposure
max r1.x, r1.x, l(0.000100)  // r1.x <- exposure

#line 84
mul r1.xyz, r0.xyzx, r1.xxxx  // r1.x <- color.x; r1.y <- color.y; r1.z <- color.z

#line 62
mov r1.w, cb0[5].x
mad r2.xyzw, r1.xyzw, l(1.425000, 1.425000, 1.425000, 1.425000), l(0.050000, 0.050000, 0.050000, 0.050000)  // r2.x <- va.x; r2.y <- va.y; r2.z <- va.z; r2.w <- va.w
mad r2.xyzw, r1.xyzw, r2.xyzw, l(0.004000, 0.004000, 0.004000, 0.004000)
mad r3.xyzw, r1.xyzw, l(1.425000, 1.425000, 1.425000, 1.425000), l(0.600000, 0.600000, 0.600000, 0.600000)
mad r1.xyzw, r1.xyzw, r3.xyzw, l(0.049100, 0.049100, 0.049100, 0.049100)
div r1.xyzw, r2.xyzw, r1.xyzw
add r1.xyzw, r1.xyzw, l(-0.082100, -0.082100, -0.082100, -0.082100)  // r1.x <- vf.x; r1.y <- vf.y; r1.z <- vf.z; r1.w <- vf.w
